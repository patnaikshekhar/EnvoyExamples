...
goog.exportSymbol('proto.envoy.data.accesslog.v2.ConnectionProperties', null, global);
...
proto.envoy.data.accesslog.v2.TCPAccessLogEntry.toObject = function(includeInstance, msg) {
  var f, obj = {
    ...
    connectionProperties: (f = msg.getConnectionProperties()) && proto.envoy.data.accesslog.v2.ConnectionProperties.toObject(includeInstance, f)
  };
...
proto.envoy.data.accesslog.v2.TCPAccessLogEntry.deserializeBinaryFromReader = function(msg, reader) {
  while (reader.nextField()) {
    ...
    case 1:
      ...
      break;
    case 2:
      var value = new proto.envoy.data.accesslog.v2.ConnectionProperties;
      reader.readMessage(value,proto.envoy.data.accesslog.v2.ConnectionProperties.deserializeBinaryFromReader);
...
proto.envoy.data.accesslog.v2.TCPAccessLogEntry.serializeBinaryToWriter = function(message, writer) {
  ...
  if (f != null) {
    writer.writeMessage(
      2,
      f,
      proto.envoy.data.accesslog.v2.ConnectionProperties.serializeBinaryToWriter
    );
  }
};
...
/**
 * optional ConnectionProperties connection_properties = 2;
 * @return {?proto.envoy.data.accesslog.v2.ConnectionProperties}
 */
proto.envoy.data.accesslog.v2.TCPAccessLogEntry.prototype.getConnectionProperties = function() {
  return /** @type{?proto.envoy.data.accesslog.v2.ConnectionProperties} */ (
    jspb.Message.getWrapperField(this, proto.envoy.data.accesslog.v2.ConnectionProperties, 2));
};


/** @param {?proto.envoy.data.accesslog.v2.ConnectionProperties|undefined} value */
proto.envoy.data.accesslog.v2.TCPAccessLogEntry.prototype.setConnectionProperties = function(value) {
  jspb.Message.setWrapperField(this, 2, value);
};


proto.envoy.data.accesslog.v2.TCPAccessLogEntry.prototype.clearConnectionProperties = function() {
 ...
 * @return {boolean}
 */
proto.envoy.data.accesslog.v2.TCPAccessLogEntry.prototype.hasConnectionProperties = function() {
 ...
 * @constructor
 */
proto.envoy.data.accesslog.v2.ConnectionProperties = function(opt_data) {
  jspb.Message.initialize(this, opt_data, 0, -1, null, null);
};
goog.inherits(proto.envoy.data.accesslog.v2.ConnectionProperties, jspb.Message);
if (goog.DEBUG && !COMPILED) {
  proto.envoy.data.accesslog.v2.ConnectionProperties.displayName = 'proto.envoy.data.accesslog.v2.ConnectionProperties';
}
 ...
 * @return {!Object}
 */
proto.envoy.data.accesslog.v2.ConnectionProperties.prototype.toObject = function(opt_includeInstance) {
  return proto.envoy.data.accesslog.v2.ConnectionProperties.toObject(opt_includeInstance, this);
};
 ...
 *     instance for transitional soy proto support:
 *     http://goto/soy-param-migration
 * @param {!proto.envoy.data.accesslog.v2.ConnectionProperties} msg The msg instance to transform.
 * @return {!Object}
 * @suppress {unusedLocalVariables} f is only used for nested messages
 */
proto.envoy.data.accesslog.v2.ConnectionProperties.toObject = function(includeInstance, msg) {
  var f, obj = {
 ...
 * @return {!proto.envoy.data.accesslog.v2.ConnectionProperties}
 */
proto.envoy.data.accesslog.v2.ConnectionProperties.deserializeBinary = function(bytes) {
  var reader = new jspb.BinaryReader(bytes);
  var msg = new proto.envoy.data.accesslog.v2.ConnectionProperties;
  return proto.envoy.data.accesslog.v2.ConnectionProperties.deserializeBinaryFromReader(msg, reader);
};
 ...
 * Deserializes binary data (in protobuf wire format) from the
 * given reader into the given message object.
 * @param {!proto.envoy.data.accesslog.v2.ConnectionProperties} msg The message object to deserialize into.
 * @param {!jspb.BinaryReader} reader The BinaryReader to use.
 * @return {!proto.envoy.data.accesslog.v2.ConnectionProperties}
 */
proto.envoy.data.accesslog.v2.ConnectionProperties.deserializeBinaryFromReader = function(msg, reader) {
  while (reader.nextField()) {
    if (reader.isEndGroup()) {
      break;
    }
 ...
 * @return {!Uint8Array}
 */
proto.envoy.data.accesslog.v2.ConnectionProperties.prototype.serializeBinary = function() {
  var writer = new jspb.BinaryWriter();
  proto.envoy.data.accesslog.v2.ConnectionProperties.serializeBinaryToWriter(this, writer);
  return writer.getResultBuffer();
};
 ...
 * Serializes the given message to binary data (in protobuf wire
 * format), writing to the given BinaryWriter.
 * @param {!proto.envoy.data.accesslog.v2.ConnectionProperties} message
 * @param {!jspb.BinaryWriter} writer
 * @suppress {unusedLocalVariables} f is only used for nested messages
 */
proto.envoy.data.accesslog.v2.ConnectionProperties.serializeBinaryToWriter = function(message, writer) {
  var f = undefined;
...
/**
 * optional uint64 received_bytes = 1;
 * @return {number}
 */
proto.envoy.data.accesslog.v2.ConnectionProperties.prototype.getReceivedBytes = function() {
  return /** @type {number} */ (jspb.Message.getFieldWithDefault(this, 1, 0));
};


/** @param {number} value */
proto.envoy.data.accesslog.v2.ConnectionProperties.prototype.setReceivedBytes = function(value) {
  jspb.Message.setProto3IntField(this, 1, value);
};


/**
 * optional uint64 sent_bytes = 2;
 * @return {number}
 */
proto.envoy.data.accesslog.v2.ConnectionProperties.prototype.getSentBytes = function() {
  return /** @type {number} */ (jspb.Message.getFieldWithDefault(this, 2, 0));
};


/** @param {number} value */
proto.envoy.data.accesslog.v2.ConnectionProperties.prototype.setSentBytes = function(value) {
...
proto.envoy.data.accesslog.v2.AccessLogCommon.toObject = function(includeInstance, msg) {
  var f, obj = {
    ...
    routeName: jspb.Message.getFieldWithDefault(msg, 19, ""),
    downstreamDirectRemoteAddress: (f = msg.getDownstreamDirectRemoteAddress()) && envoy_api_v2_core_address_pb.Address.toObject(includeInstance, f),
    filterStateObjectsMap: (f = msg.getFilterStateObjectsMap()) ? f.toObject(includeInstance, proto.google.protobuf.Any.toObject) : []
  };
...
proto.envoy.data.accesslog.v2.AccessLogCommon.deserializeBinaryFromReader = function(msg, reader) {
  while (reader.nextField()) {
    ...
    case 20:
      var value = new envoy_api_v2_core_address_pb.Address;
      reader.readMessage(value,envoy_api_v2_core_address_pb.Address.deserializeBinaryFromReader);
      msg.setDownstreamDirectRemoteAddress(value);
      break;
    case 21:
      var value = msg.getFilterStateObjectsMap();
...
proto.envoy.data.accesslog.v2.AccessLogCommon.serializeBinaryToWriter = function(message, writer) {
  ...
  f = message.getDownstreamDirectRemoteAddress();
  if (f != null) {
    writer.writeMessage(
      20,
      f,
  ...
  f = message.getFilterStateObjectsMap(true);
  if (f && f.getLength() > 0) {
...
/**
 * optional string route_name = 19;
 * @return {string}
 */
proto.envoy.data.accesslog.v2.AccessLogCommon.prototype.getRouteName = function() {
  return /** @type {string} */ (jspb.Message.getFieldWithDefault(this, 19, ""));
};


/** @param {string} value */
proto.envoy.data.accesslog.v2.AccessLogCommon.prototype.setRouteName = function(value) {
  jspb.Message.setProto3StringField(this, 19, value);
};


/**
 * optional envoy.api.v2.core.Address downstream_direct_remote_address = 20;
 * @return {?proto.envoy.api.v2.core.Address}
 */
proto.envoy.data.accesslog.v2.AccessLogCommon.prototype.getDownstreamDirectRemoteAddress = function() {
  return /** @type{?proto.envoy.api.v2.core.Address} */ (
    jspb.Message.getWrapperField(this, envoy_api_v2_core_address_pb.Address, 20));
};


/** @param {?proto.envoy.api.v2.core.Address|undefined} value */
proto.envoy.data.accesslog.v2.AccessLogCommon.prototype.setDownstreamDirectRemoteAddress = function(value) {
  jspb.Message.setWrapperField(this, 20, value);
};


proto.envoy.data.accesslog.v2.AccessLogCommon.prototype.clearDownstreamDirectRemoteAddress = function() {
  this.setDownstreamDirectRemoteAddress(undefined);
};
 ...
 * @return {boolean}
 */
proto.envoy.data.accesslog.v2.AccessLogCommon.prototype.hasDownstreamDirectRemoteAddress = function() {
 ...
 */
proto.envoy.data.accesslog.v2.AccessLogCommon.prototype.getFilterStateObjectsMap = function(opt_noLazyCreate) {
...
proto.envoy.data.accesslog.v2.AccessLogCommon.prototype.clearFilterStateObjectsMap = function() {
  this.getFilterStateObjectsMap().clear();
};
...
proto.envoy.data.accesslog.v2.ResponseFlags.toObject = function(includeInstance, msg) {
  var f, obj = {
    ...
    invalidEnvoyRequestHeaders: jspb.Message.getFieldWithDefault(msg, 18, false),
    downstreamProtocolError: jspb.Message.getFieldWithDefault(msg, 19, false)
  };
